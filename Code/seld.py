...
import cls_data_generator_new as cls_data_generator
...
def collect_test_labels(_data_gen_test, _data_out, quick_test, quick_test_dim):
    # Collecting ground truth for test data
    nb_batch = quick_test_dim if quick_test else _data_gen_test.get_total_batches_in_data()
...
def main(argv):
    ...
    #To be used after training, useless for now
    val_splits = [1]
    ...
    for split_cnt, split in enumerate(test_splits):
        ...
        gt = collect_test_labels(data_gen_test, data_out, params['quick_test'], params['quick_test_dim'])
